...

{
    ...
    //class Barcode :  BarcodeCreator.Barcode, ICloneable
    {
        ...
        public Barcode(string barcode, string discription,string itemcode)
            : base(barcode,discription,itemcode)
        {
            this.initBarcode(barcode, discription, itemcode);
        }
